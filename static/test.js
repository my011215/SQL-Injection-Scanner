window.onload=function(){
    ...
    httpRequest.open('GET', 'http://127.0.0.1:5000/BugSearch2', true);//第二步：打开连接  将请求参数写在url中  ps:"http://localhost:8080/rest/xxx"
...
//    document.getElementById("form4").innerHTML=text+'x';
//}
var t = null;
...
function time() {
    ...
    httpRequest.open('GET', 'http://127.0.0.1:5000/BugSearch0', false);//第二步：打开连接  将请求参数写在url中  ps:"http://localhost:8080/rest/xxx"
    httpRequest.send(null);//第三步：发送请求  将请求参数写在URL中
    document.getElementById("form4").innerHTML=httpRequest.responseText;
